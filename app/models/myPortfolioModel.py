...
from sqlalchemy import Column, String, DECIMAL, Integer, Numeric, DateTime, UniqueConstraint
...
class MyPortfolio(db.Model):
    ...
    averagePrice = Column(Numeric(16, 2), nullable=True)
    currentPrice = Column(Numeric(16, 2), nullable=True)
...
class ExchangeRate(db.Model):
    ...
    exchangeRate = Column(DECIMAL(16, 2), nullable=False)          # 기준 통화에서 대상 통화로의 환율
...
class MyAccounts(db.Model):
    __tablename__ = 'my_accounts'
